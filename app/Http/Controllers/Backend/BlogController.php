...
class BlogController extends BackendController
{
    ...
    public function store(Requests\PostRequest $request)
    {
        ...
        $newPost->createTags($data["post_tags"]);
         ...
         return redirect('backend/blog')->with('message', 'Your post wes created successfully!');
    }
    ...
    public function update(Requests\PostRequest $request, $id)
    {
        ...
        return redirect('/backend/blog')->with('message', 'Your post wes updated successfully!');
    }
    ...
    public function forceDestroy($id)
    {
        ...
        return redirect('/backend/blog?status=trash')->with('message', 'You post has been deleted successfully');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->back()->with('message', 'You post has been moved form the Trash');
    }
